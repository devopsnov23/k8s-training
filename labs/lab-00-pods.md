...
Chapter 7, "Service Discovery," in Kubernetes Up and Running, third edition, shows you how to expose a service to the world or other containers using load balancers⁠—but often you simply want to access a specific Pod, even if it’s not serving traffic on the internet.
